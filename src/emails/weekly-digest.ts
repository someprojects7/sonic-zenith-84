...
<tr>
  <td style="padding:0 0 10px 0;">
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color:${CANVAS};border:1px solid ${LINE};border-radius:10px;"><tr><td style="padding:12px 14px;">
